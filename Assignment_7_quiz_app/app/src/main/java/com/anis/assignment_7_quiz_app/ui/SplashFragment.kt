...
import com.anis.assignment_7_quiz_app.utils.PrefManager
...
class SplashFragment : BaseFragment() {
    ...
    fun addQuestionsToDB(){
        val quiz1 = Quiz(1L,"1) Kotlin is","A. Programming language", "B. a web browser","C. a web server","D. None of the above","a","Answer: (a) a programming language\n" +
                "\n" +
                "Kotlin is a  modern programming language that makes developers happier.")
        val quiz2 = Quiz(2L,"2) LinkedIn is ?", "A. University","B. Date app","C. Professional social media","D. None of the above","c","Answer: (c) Professional social media\n" +
                "\n" +
